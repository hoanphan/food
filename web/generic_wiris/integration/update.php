...
echo '<h3>Forbidden</h3><p>If you are the server administrator, comment the first code line in change.php script.</p>'; 
die();
...
echo '<p>Remember to uncomment the security line in change.php file to forbid the access to this script to the public.</p>';
